...
- 🧊 **3D Tilt Effect:** Karta przechyla się w stronę kursora z realistycznym odblaskiem (dzięki Vanilla-Tilt.js).
- 📱 **RWD:** Pełna responsywność na urządzeniach mobilnych.
- ⚡ **SPA Navigation:** Płynne przejścia między formularzami (JS).
- 🎭 **Animowane tło:** Dynamiczne kule i subtelny wzór kropek (dot pattern).

## Technologie
- HTML5
- CSS3 (Flexbox, CSS Animations, Backdrop Filter)
- JavaScript (Vanilla JS)
- [Vanilla-Tilt.js](https://micku7zu.github.io/vanilla-tilt.js/) (biblioteka do efektu 3D)
- [RemixIcon](https://remixicon.com/) (ikony)
